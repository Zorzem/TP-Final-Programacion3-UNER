...
VALUES (
        ...
        'López',
        'alblop@correo.com',
        'cf584badd07d42dcb8506f8bae32aa96',
        3,
        NULL,
        NULL,
        1,
    ...
    (
        ...
        'Gómez',
        'pamgom@correo.com',
        '709ee61c97fc261d35aa2295e109b3fb',
        3,
        NULL,
        NULL,
        1,
    ...
    (
        ...
        'Ciro',
        'estcir@correo.com',
        'da6541938e9afdcd420d1ccfc7cac2c7',
        3,
        NULL,
        NULL,
        1,
    ...
    (
        ...
        'Ramirez',
        'oscram@correo.com',
        '0ac879e8785ea5b3da6ff1333d8b0cf2',
        1,
        NULL,
        NULL,
        1,
    ...
    (
        ...
        'Juárez',
        'clajua@correo.com',
        '4f9dbdcf9259db3fa6a3f6164dd285de',
        1,
        NULL,
        NULL,
        1,
    ...
    (
        ...
        'Corbalán',
        'wilcor@correo.com',
        'f68087e72fbdf81b4174fec3676c1790',
        2,
        NULL,
        NULL,
        1,
    ...
    (
        ...
        'Flores',
        'anaflo@correo.com',
        'd4e767c916b51b8cc5c909f5435119b1',
        2,
        NULL,
        NULL,
        1,
...
ALTER TABLE `salones` ADD PRIMARY KEY (`salon_id`);

-- Indices de la tabla `servicios`
ALTER TABLE `servicios` ADD PRIMARY KEY (`servicio_id`);

-- Indices de la tabla `turnos`
ALTER TABLE `turnos` ADD PRIMARY KEY (`turno_id`);
...
ALTER TABLE `reservas_servicios`
MODIFY `reserva_servicio_id` int(11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 11;
...
-- MODIFICACIONES FINALES AL MODELO:
ALTER TABLE salones
...
CREATE TABLE encuestas (
  ...
  activo TINYINT(1) NOT NULL DEFAULT 1,
  CONSTRAINT fk_encuesta_reserva FOREIGN KEY (reserva_id) REFERENCES reservas(reserva_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
